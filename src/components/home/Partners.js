...
import pythonNpImage from "../../assets/images/partners/python_nepal.png";
    ...
    <div className=" shadow p-4 partners mt-5">
      <div className="row">
        <div className="col-lg-4 text-center">
          <center>
            <b class="partner-title">Community Partner</b>
          </center>
          <br />
        ...
        <div className="col-lg-2 text-center">
          <center>
            <b class="partner-title">Organized By</b>
          </center>
          <br />
        ...
        <div className="col-lg-2 text-center">
          <center>
            <b class="partner-title">Event Partner</b>
          </center>
          <br />
        ...
        <div className="col-lg-4 text-center">
          <center>
            <b class="partner-title">Media Partner</b>
          </center>
          <br />
